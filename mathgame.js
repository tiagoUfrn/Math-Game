...
function preload() {
    ...
    imginst= loadImage("./imagens/tela instru.png");
    imgmenu = loadImage("./imagens/menu.png");
    imgcred = loadImage("./imagens/tela creditos.png");
    fontChango = loadFont("./fonte/static/DancingScript-VariableFont_wght.ttf")
